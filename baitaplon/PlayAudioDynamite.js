...
export default function PlayAudioDynamit({navigation}) {
  ...
  const formatTime = (milliseconds) => {
   ...
   return(
      <ScrollView style={styles.container}>
          <ImageBackground source={require("./PlayAnAudio/Image58.png")} style={{width:"100%",height:"100%", resizeMode: 'cover'}}>
          ...
          <View style={{flex:1,backgroundColor :"rgba(0,0,0,0.4)",width:"100%",marginTop : 450}} >
            <View style={{marginHorizontal : 20}}>
                <Text style={{fontSize : 30 , fontWeight :'500' , color:'white'}}>Dynamite</Text>
                <Text style={{fontSize : 18,fontWeight:'300',color:'white'}}>Elena Jimenez</Text>

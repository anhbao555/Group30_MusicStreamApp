...
export default function PlayAnAudio({navigation}) {
      ...
      <ScrollView style={styles.container}>
          ...
          <View style={{flex:1,backgroundColor :"rgba(0,0,0,0.4)",width:"100%",marginTop : 450}} >
            <View style={{marginHorizontal : 20}}>
                <Text style={{fontSize : 30 , fontWeight :500 , color:'white'}}>FLOWER</Text>
                <Text style={{fontSize : 18,fontWeight:300,color:'white'}}>Jessica Gonzalez</Text>

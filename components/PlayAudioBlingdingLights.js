...
export default function PlayAudioBlingdingLights({navigation}) {
  ...
  const formatTime = (milliseconds) => {
   ...
   return(
      <ScrollView style={styles.container}>
          <ImageBackground source={require("../AudioListing-Search/Image86.png")} style={{width:"100%",height:"100%", resizeMode: 'cover'}}>
          ...
          <View style={{flex:1,backgroundColor :"rgba(0,0,0,0.4)",width:"100%",marginTop : 450}} >
            <View style={{marginHorizontal : 20}}>
                <Text style={{fontSize : 30 , fontWeight :'500' , color:'white'}}>Blinding Lights</Text>
                <Text style={{fontSize : 18,fontWeight:'300',color:'white'}}>Brian Bailey</Text>
